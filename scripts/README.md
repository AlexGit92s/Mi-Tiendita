...
| 014 | [migrations/014_public_tracking_event_aliases.sql](./migrations/014_public_tracking_event_aliases.sql) | Normaliza aliases de eventos publicos y permite seguimiento con producto desligado | pendiente |
| 015 | [migrations/015_auto_commit_stock_on_reservation.sql](./migrations/015_auto_commit_stock_on_reservation.sql) | Trigger BEFORE INSERT en `reservations` que descuenta stock automaticamente al crearse el apartado | pendiente |
